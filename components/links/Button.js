...
function LinkedInButton() {
  return (
    <Link
      href={"https://www.linkedin.com/in/lucas-andrianarijaona-7039641b8/"}
      passHref={true}
    >
      <a
        target="_blank"
        className="group rounded-full shadow-lg shadow-gray-400 p-[18px] lg:p-6 cursor-pointer hover:scale-110 ease-in duration-300"
      >
...
function CVButton() {
  return (
    <Link href={"/assets/Lucas Andrianarijaona.pdf"} passHref={true}>
      <a className="group rounded-full shadow-lg shadow-gray-400 p-[18px] lg:p-6 cursor-pointer hover:scale-110 ease-in duration-300">
