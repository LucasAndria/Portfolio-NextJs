...
function Contact() {
  ...
  const [submitInnerText, setSubmitInnerText] = useState("Send Message");
  const form = useRef();

  async function sendEmail(e) {
    e.preventDefault();
    setSubmitInnerText("Loading...");
    ...
    setSubmitInnerText("Send Message");
    e.target.reset();
  }
          ...
          <div className="col-span-3 lg:col-span-2 w-full shadow-xl shadow-gray-400 rounded-xl p-4">
            <div className="lg:p-4 h-full">
              ...
              <div className="mt-5">
                ...
                <p className="py-2 font-bold flex gap-3">
                  lucasandria01@gmail.com
                  <button
                  ...
                  >
                    <svg
                      className={
                        copyMailLoaded
                          ? "bi bi-check w-4 h-4 text-white animate-ping absolute text-center"
                          : "bi bi-check hidden"
                      }
                    ...
                    <span className={copyMailLoaded ? "invisible" : ""}>
                      <svg
                        className="bi bi-clipboard w-4 h-4 text-white text-center"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        viewBox="0 0 16 16"
                      >
          ...
          <div className="col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4">
            <div className="p-4">
              <form ref={form} onSubmit={sendEmail}>
                ...
                <input
                  type="submit"
                  value={submitInnerText}
                  className="w-full bg-transparent mt-4 hover:bg-[#5651e5] text-[#5651e5] cursor-pointer font-semibold hover:text-white py-2 px-4 border border-[#5651e5] hover:border-transparent rounded"
                />
              </form>
            </div>
          </div>
          ...
          <Link href="/">
            <div className="group rounded-full shadow-lg shadow-gray-400 p-[20px] lg:p-6 cursor-pointer hover:scale-105 ease-in duration-300">
              <HiOutlineChevronDoubleUp
                className="text-[#5651e5] group-hover:animate-bounce"
                size={30}
              />
            </div>
          </Link>
